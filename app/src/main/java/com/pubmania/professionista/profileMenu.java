                                    ...
                                    try {
                                        ...
                                        httpsReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                            ...
                                            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                                ...
                                                editor.putString("urlFoto",documentSnapshot.getString("fotoProfilo"));
                            ...
                            documentReference1.update( "nome",nome ).addOnCompleteListener( new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if(!sharedPreferences.getString("nomeCognome","null").equals("null")) {
                                        String[] split = sharedPreferences.getString("nomeCognome", "nmull").split(" ");
                                        if(split.length > 1) {
                                            Log.d("jnajskndjkan", sharedPreferences.getString("nomeCognome", "null"));
                                            String fin = nome + " " + split[1];
                                            editor.putString("nomeCognome", fin);
                                        }else{
                                            editor.putString("nomeCognome", nome + " ");
                                        }
                                    }else{
                                        editor.putString("nomeCognome",nome+" ");
                                    }
